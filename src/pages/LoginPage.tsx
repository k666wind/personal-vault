...
export default function LoginPage() {
  const { t, setLanguage, settings } = useAppStore()
    ...
    <div className="login-page">
      <div className="login-card">
        ...
        <div className="login-logo">
          ...
          <h1 className="app-name">Vault</h1>
          <p className="app-tagline">{t('auth', 'appTagline')}</p>
        </div>
        ...
        <button className="btn-primary" onClick={handleEmailAuth} disabled={loading}>
          {loading ? t('common', 'loading') : mode === 'login' ? t('auth', 'signIn') : t('auth', 'register')}
        </button>
